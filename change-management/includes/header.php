...
<div class="header changes-header">
    ...
    <nav class="header-nav">
        <a href="<?php echo BASE_URL; ?>change-management/" class="nav-btn <?php echo $current_page === 'changes' ? 'active' : ''; ?>" title="Changes">
        ...
        <a href="<?php echo BASE_URL; ?>change-management/calendar.php" class="nav-btn <?php echo $current_page === 'calendar' ? 'active' : ''; ?>" title="Calendar">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="<?php echo BASE_URL; ?>change-management/approvals.php" class="nav-btn <?php echo $current_page === 'approvals' ? 'active' : ''; ?>" title="Approvals">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="<?php echo BASE_URL; ?>change-management/settings/" class="nav-btn <?php echo $current_page === 'settings' ? 'active' : ''; ?>" title="Settings">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="<?php echo BASE_URL; ?>change-management/help.php" class="nav-btn <?php echo $current_page === 'help' ? 'active' : ''; ?>" title="Help">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
