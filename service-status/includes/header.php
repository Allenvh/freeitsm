...
<div class="header service-status-header">
    ...
    <nav class="header-nav">
        <a href="<?php echo BASE_URL; ?>service-status/" class="nav-btn <?php echo $current_page === 'dashboard' ? 'active' : ''; ?>" title="Status">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>
            </svg>
            <span>Status</span>
        </a>
        <a href="<?php echo BASE_URL; ?>service-status/settings/" class="nav-btn <?php echo $current_page === 'settings' ? 'active' : ''; ?>" title="Settings">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="<?php echo BASE_URL; ?>service-status/help.php" class="nav-btn <?php echo $current_page === 'help' ? 'active' : ''; ?>" title="Help">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
