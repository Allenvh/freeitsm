<?php
/**
 * Calendar Module Header Component
 *
...
<div class="header calendar-header">
    ...
    <nav class="header-nav">
        <a href="<?php echo $path_prefix; ?>calendar/" class="nav-btn <?php echo $current_page === 'calendar' ? 'active' : ''; ?>" title="Calendar">
        ...
        <a href="<?php echo $path_prefix; ?>calendar/settings/" class="nav-btn <?php echo $current_page === 'settings' ? 'active' : ''; ?>" title="Settings">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="<?php echo $path_prefix; ?>calendar/help.php" class="nav-btn <?php echo $current_page === 'help' ? 'active' : ''; ?>" title="Help">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
