...
<div class="header workflow-header">
    ...
    <nav class="header-nav">
        <a href="<?php echo BASE_URL; ?>workflow/" class="nav-btn <?php echo $current_page === 'workflow' ? 'active' : ''; ?>" title="<?php echo htmlspecialchars(function_exists('t') ? t('workflow.nav.workflows') : 'Workflows'); ?>">
        ...
        <a href="<?php echo BASE_URL; ?>workflow/settings/" class="nav-btn <?php echo $current_page === 'settings' ? 'active' : ''; ?>" title="<?php echo htmlspecialchars(function_exists('t') ? t('workflow.nav.settings') : 'Settings'); ?>">
            ...
            <span><?php echo htmlspecialchars(function_exists('t') ? t('workflow.nav.settings') : 'Settings'); ?></span>
        </a>
        <a href="<?php echo BASE_URL; ?>workflow/help.php" class="nav-btn <?php echo $current_page === 'help' ? 'active' : ''; ?>" title="<?php echo htmlspecialchars(function_exists('t') ? t('workflow.nav.help') : 'Help'); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
